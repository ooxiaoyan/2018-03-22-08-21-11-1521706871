...
public class Teacher extends Person {
    ...
    public void joinStudent(Student student) {
        System.out.print("I am " + super.getName() + ". I know " + student.getName() + " has joined Class " + student.getKlass().getNumber() + ".\n");
    }

    public void becomeLeader(Student student) {
        System.out.print("I am " + super.getName() + ". I know " + student.getName() + " become Leader of Class " + student.getKlass().getNumber() + ".\n");
    }
}
